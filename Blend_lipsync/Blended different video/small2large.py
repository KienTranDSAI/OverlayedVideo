...
cap = cv2.VideoCapture("../simon_silence.mp4")
...
# out = cv2.VideoWriter('/home/kientran/Code/Work/Overlayed video/Blend_lipsync/Blended different video/Small2Large.mp4', fourcc, 30.0, (int(baseCap.get(3)), int(baseCap.get(4))))
